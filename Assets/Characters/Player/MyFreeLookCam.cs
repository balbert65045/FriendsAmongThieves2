...
namespace UnityStandardAssets.Cameras
{
    public class MyFreeLookCam : PivotBasedCameraRig
    {
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            //New method for over the shoulder

            transform.position = Vector3.Lerp(transform.position, m_Target.position + transform.right * ShoulderOffset, deltaTime * m_MoveSpeed);
