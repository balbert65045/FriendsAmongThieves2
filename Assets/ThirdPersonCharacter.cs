...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
        ...
        public void ShrinkCapsuleCollider()
        {
            ...
            VaultUp = true;
            VaultUpPosition = transform.position + Vector3.up;
        }
        ...
        public void RenableGroundCheck()
        {
        ...
        private void Update()
        {
            if (VaultUp)
            {
                transform.Translate(Vector3.up * VaultUpSpeed);
            }
        }
		...
		void UpdateAnimator(Vector3 move)
		{
            ...
            if (!DisableGroundCheck) { m_Animator.SetBool("OnGround", m_IsGrounded); }
